package com.zippt.l3l4sa;

import com.zippt.l3l4sa.client.control.AuctionClientControl;
...
import com.zippt.l3l4sa.server.domain.AgentCredential;
...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("[ZIP-PT L3+L4+SA] demo completed");
    ...
    private static void seed(DataStore store) {
        ...
        AgentCredential credential = new AgentCredential("credential-1", "agent-1", "LIC-001", "OFFICE-1");
        credential.verify();
